...
Bidding Analyzer:     Dealer: North     Vulnerability: none
    1H by N                 pts:13-21   C:?    D:?    H:5+*  S:0-5  Simple opening bid (std-simple-suit-opens)
  pass by E                 pts:0-12    C:?    D:?    H:?    S:?    No suitable overcall (std-initial-pass)
    1S by S forcing:yes     pts:6+      C:?    D:?    H:?    S:4+*  6+ points, 4+ spades (std-simple-suit-open-responses)
  pass by W                 pts:0-12    C:?    D:?    H:?    S:?    No suitable bid (std-defense-logical)
    2C by N forcing:yes     pts:15-21   C:4-5* D:?    H:5+*  S:0-5  New suit: 4+ cards, extra values (std-offense-logical)
  pass by E                 pts:0-12    C:?    D:?    H:?    S:?    No suitable bid (std-defense-logical)
    2H by S                 pts:6-8     C:?    D:?    H:3+   S:4+*  Rebid partner's suit, forcing: fit, minimum (std-offense-logical)
  pass by W                 pts:0-12    C:?    D:?    H:?    S:?    No suitable bid (std-defense-logical)
    4H by N                 pts:18-21   C:4-5* D:?    H:5+*  S:0-5  Game (std-offense-logical)
  pass by E                 pts:0-12    C:?    D:?    H:?    S:?    No suitable bid (std-defense-logical)
  pass by S                 pts:6-8     C:?    D:?    H:3+   S:4+*  Accept game contract (std-offense-logical)
  pass by W                 pts:0-12    C:?    D:?    H:?    S:?    No suitable bid (std-defense-logical)
Partnership: NS    fits: H                       offense-passed
  North      pts:18-21   C:4-5* D:?    H:5+*  S:0-5 
  South      pts:6-8     C:?    D:?    H:3+   S:4+* 
